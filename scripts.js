...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (!sidebar || !sidebarToggle || !sidebarClose || !sidebarCollapseToggle || !sidebarOverlay) return;
  const SIDEBAR_COLLAPSED_KEY = 'mekongstem.smart-home.sidebar-collapsed';
  ...
  const setSidebarCollapsed = (isCollapsed) => {
    ...
    sidebarCollapseToggle.setAttribute('aria-label', isCollapsed ? 'Mở rộng menu' : 'Thu gọn menu');
    sidebarCollapseToggle.title = isCollapsed ? 'Mở rộng menu' : 'Thu gọn menu';
  ...
  sidebarCollapseToggle.setAttribute('aria-controls', 'navigationSidebar');
  ...
  sidebarCollapseToggle.addEventListener('click', () => setSidebarCollapsed(!document.body.classList.contains('sidebar-collapsed')));
